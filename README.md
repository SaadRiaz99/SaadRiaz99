...
| AI & LLMs | Gemini API, Ollama, LangChain, LangGraph, CrewAI, AutoGen |
| Agent Protocols | MCP (Model Context Protocol), Function Calling, Tool-Use |
| Automation | LinkedIn/Gmail agent automation, MCP servers, API integration |
| Infrastructure | FastAPI, Docker, MySQL, PostgreSQL, Git |
| Concepts | Agentic RAG, Multi-Agent Systems, Prompt Engineering, LLMOps |
...
### LinkedIn & Gmail Automation Agents
Custom agents using Gemini API + MCP for automated LinkedIn outreach, profile management, and email workflow automation. API-key based, CLI-driven deployment.
...
- **Multi-Agent Systems** — LangGraph deep-dive, agent communication patterns
- **Production Agents** — FastAPI serving, Docker, free-tier deployment
- **Earning via Agents** — freelancing agent automation services
